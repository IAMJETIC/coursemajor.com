            ...
            <div>
                ...
                <div className="productOverview">
                    ...
                    <div className="playlist-video">
                        {console.log("lol")}
                        {console.log(`/uploads/${playlistDetail.playlist.videoplaylist[0].File}`)}
                        <ReactPlayer 
                            controls 
                            url={`/${playlistDetail.playlist.videoplaylist[0].File}`}
                        ...
                        <ul>
                            {playlistDetail.loading ? (
                                ...
                                playlist.videoplaylist.map((playlist) => {
                                    return (
                                        <li>
                                            <Link className="playlist-link" href="#">
                ...
                <div className="productOverviewInfo">
                    ...
                    <div className="cells">
                        ...
                        <div className="ratings">
                            <Rating rating={course.star}></Rating>
                        </div>
                    </div>
